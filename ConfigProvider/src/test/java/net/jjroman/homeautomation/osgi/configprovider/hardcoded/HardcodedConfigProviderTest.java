...
public class HardcodedConfigProviderTest {
    ...
    public void testProvideConfigsRequiredByCoalBurner(){
        ...
        assertNotNull(configService.getConfigValueByNamespaceAndKey("coalburner", CoalBurner.CONFIG_GOTO_ACTIVE_TEMP));
        assertNotNull(configService.getConfigValueByNamespaceAndKey("coalburner", CoalBurner.CONFIG_GOTO_STANDBY_TEMP));
    ...
    public void testProvideConfigsRequiredByCoalBurnerParsableDoubles(){
        ...
        Double v1 =
                Double.parseDouble(
                configService.getConfigValueByNamespaceAndKey("coalburner", CoalBurner.CONFIG_GOTO_ACTIVE_TEMP));
        assertNotNull(v1);

        Double v2 =
                Double.parseDouble(
                        configService.getConfigValueByNamespaceAndKey("coalburner", CoalBurner.CONFIG_GOTO_STANDBY_TEMP));
        assertNotNull(v2);
    }
